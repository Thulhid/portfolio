      ...
      <div className="flex w-fit flex-col items-center md:flex-row xl:ml-15">
        <div className="order-2 mt-5 flex flex-col items-center md:order-1">
          <p className="mx-3 my-5 max-w-xl space-y-3 text-base text-gray-800 md:mt-10 md:mb-15 xl:text-lg dark:text-gray-300">
            I&apos;m a frontend developer with deep understanding of React.js
            and experience building dynamic, scalable applications using tools
            like Redux, React Query, and Next.js. With a solid understanding of
            UI/UX principles and a passion for clean, user friendly design,
